...
11. Các tiêu đề phần, mục lớn (như "I. MỤC ĐÍCH, YÊU CẦU", "II. NỘI DUNG", "III. TỔ CHỨC THỰC HIỆN"...) phải viết hoa, in đậm, căn lề trái và lùi đầu dòng 1,27cm (KHÔNG được căn giữa). Chỉ có tiêu đề lớn của toàn bộ văn bản (ví dụ: KẾ HOẠCH, QUYẾT ĐỊNH, BÁO CÁO) mới được căn giữa.
